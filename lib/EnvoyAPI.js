...
class EnvoyAPI {
  ...
  async flows(locationId) {
    ...
    const response = await this.request.get('/api/v3/flows', {
      params: {
        filter: {
          location: locationId,
        },
    ...
    return EnvoyAPI.getDataFromBody(response.data, data => Array.isArray(data));
  }

  async flow(flowId) {

    const response = await this.request.get(`/api/v3/flows/${flowId}`).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });

    return EnvoyAPI.getDataFromBody(response.data);
  }
  
  async locations() {

    const response = await this.request.get('/api/v3/locations').catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async location(locationId) {
    ...
    const response = await this.request.get(`/api/v3/locations/${locationId}`).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async company() {
    ...
    const response = await this.request.get('/api/v2/companies').catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async me() {
    ...
    const response = await this.request.get('/api/v2/users/me').catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async companyRoles(userId) {
    ...
    const response = await this.request.get(`/api/v3/users/${userId}/relationships/company-roles`).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async employee(companyRoleId) {
    ...
    const response = await this.request.get(`/api/v3/company-roles/${companyRoleId}/employee`).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async locationEmployees(locationId, params = {}) {
    ...
    const response = await this.request.get(`/api/v3/locations/${locationId}/employees`, {
      params,
    }).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async locationEmployee(employeeId) {
    ...
    const response = await this.request.get(`/api/v3/employees/${employeeId}`).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async flowBadge(flowId) {
    ...
    const response = await this.request.get(`/api/v3/flows/${flowId}/badge`).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async signInPage(flowId) {
    ...
    const response = await this.request.get(`/api/v3/flows/${flowId}/sign-in-field-page`).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async signInFields(pageId) {
    ...
    const response = await this.request.get(`/api/v3/sign-in-field-pages/${pageId}/sign-in-fields`).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async createNotificationEvent(event) {
    ...
    const response = await this.request.post('/api/v2/platform/notification-events', event).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async createInvite(invite) {
    ...
    const response = await this.request.post('/api/v3/invites', invite).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async updateInvite(inviteId, invite) {
    ...
    const response = await this.request.put(`/api/v3/invites/${inviteId}`, invite).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async partialUpdateInvite(inviteId, invite) {
    ...
    // eslint-disable-next-line no-param-reassign
    invite.data.id = inviteId;
    const response = await this.request.patch(`/api/v3/invites/${inviteId}`, invite).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async updateJob(jobId, updates) {
    ...
    const response = await this.request.patch(`/api/v2/plugin-services/jobs/${jobId}`, updates).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async getPluginInstallConfig(installId) {
    const response = await this.request.get(`/api/v2/plugin-services/installs/${installId}/config`).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async setPluginInstallConfig(installId, config = {}) {
    const response = await this.request.put(`/api/v2/plugin-services/installs/${installId}/config`, config).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async storagePipeline(commands, installId = null) {
    ...
    const response = await this.request.post('/api/v2/plugin-services/storage', request).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
  ...
  async createNotification(installId, params = {}) {
    const response = await this.request.post(`/api/v2/plugin-services/installs/${installId}/notifications`, params).catch((error) => {
      return EnvoyAPI.safeRequestsError(error);
    });
    return EnvoyAPI.getDataFromBody(response.data);
  }
