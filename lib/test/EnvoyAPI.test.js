...
describe('EnvoyAPI methods', () => {
    ...
    */
    ...
    describe("Entries", () => {
        ...
        describe('entries()', () => {
            it('should return a list of entries filtered by params', async () => {
                let entry = await envoy.entries({
                    locationIds: ['143497'],
                    email: "email@example.com"
                });

                expect(entry[0].email).toEqual("email@example.com");
            });

            it('should return status 400 on improper entry object', async () => {
                let errMsg = null;

                try {
                    await envoy.entries({ signedInAtAfter: 'Fail' });
                } catch (err) {
                    errMsg = err.statusCode;
                }
        ...
        describe('entryCreate()', () => {
            it('should create an entry', async () => {
                let entry = await envoy.entryCreate({
                    locationId: '143497',
                    flowId: '346982',
                ...
                entryId = entry.id;
                expect(entry.email).toEqual('bigheadenvoy@gmail.com');
            });
            ...
            it('should return status 400 on improper entry object', async () => {
                ...
                try {
                    await envoy.entryCreate({ fail: 'Fail' });
                } catch (err) {
                    errMsg = err.statusCode;
                }
        ...
        describe('getEntry()', () => {
            it('should create an entry', async () => {
                let entry = await envoy.getEntry(entryId);
                expect(entry.email).toEqual('bigheadenvoy@gmail.com');
            });

            it('should return status 404 when no entry found', async () => {
                let errMsg = null;

                try {
                    await envoy.getEntry('Fail');
                } catch (err) {
                    errMsg = err.statusCode;
                }
        ...
        describe('updateEntry()', () => {
            it('should update an entry', async () => {
                let entry = await envoy.updateEntry({
                    id: entryId,
                    fullName: 'Nelson Bighetti'
                });

                expect(entry.fullName).toEqual('Nelson Bighetti');
            });
            ...
            it('should return status 404 when no entry found', async () => {
                ...
                try {
                    await envoy.updateEntry({ id: 'Fail' });
                } catch (err) {
                    errMsg = err.statusCode;
                }
            ...
            it('should return status 400 when bad params are passed', async () => {
                let errMsg = null;

                try {
                    await envoy.updateEntry({ id: entryId, customFields: 'Fail' });
                } catch (err) {
                    errMsg = err.statusCode;
                }
    ...
    describe('Legacy Entries ', () => {
        ...
        describe('getEntriesByDate', () => {
            it('should return entries by dates', async () => {
        ...
        describe('entry()', () => {
            it('should return entry by entry ID', async () => {
        ...
        describe('patchEntry()', () => {
            it('should update an entry found via entry ID', async () => {
    ...
    describe('Install Configs', () => {
        ...
        describe('setPluginInstallConfig()', () => {
            it('should return updated install configs given an install id', async () => {
                let configs = await envoy.setPluginInstallConfig(installId, {
                    updateTest: 'updated',
                });
