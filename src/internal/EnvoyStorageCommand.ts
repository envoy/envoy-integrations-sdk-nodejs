...
export interface EnvoyBaseStorageCommand {
  action: 'get' | 'set' | 'set_unique' | 'set_unique_num' | 'unset' | 'update',
  key: string,
}
...
export interface EnvoyUpdateStorageCommand extends EnvoyBaseStorageCommand {
  action: 'update',
  value: unknown,
}
